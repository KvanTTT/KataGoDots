...
class TrainingDataWriter {
 public:
  TrainingDataWriter(const std::string& newOutputDir, std::ostream* newDebugOut, int inputsVersion, int maxRowsPerFile, double firstFileMinRandProp, int dataXLen, int dataYLen, const std::string& randSeed, int onlyWriteEvery = 1, bool dotsGame = false);
  ~TrainingDataWriter();
