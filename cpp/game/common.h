...
const std::string DOTS_NOTAGO_STANDARD_RULES = "notago";
const std::string DOTS_BBS_STANDARD_RULES = "bbs";
const std::string SUICIDE_LEGAL_KEY = "suicideLegal";
const std::string SUICIDE_LEGALS_KEY = "suicideLegals";
