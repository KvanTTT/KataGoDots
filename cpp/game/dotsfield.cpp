...
std::pair<float, float> Board::getAcceptableKomiRange(const bool allowDraw) const {
  assert(rules.isDots);
  auto lowerBound = static_cast<float>(-whiteScoreIfBlackGrounds) + (allowDraw ? 0.0f : 0.5f);
