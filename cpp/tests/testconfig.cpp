...
ee_ = 3
    ...
    testAssert(128 == cfg.getOrDefaultInt("a1", std::numeric_limits<int>::lowest(), std::numeric_limits<int>::max(), 128));
    testAssert(128L == cfg.getOrDefaultInt64("b1", std::numeric_limits<int64_t>::lowest(), std::numeric_limits<int64_t>::max(), 128L));
    testAssert(128UL == cfg.getOrDefaultUInt64("c1", std::numeric_limits<uint64_t>::lowest(), std::numeric_limits<uint64_t>::max(), 128UL));
    testAssert(128.0f == cfg.getOrDefaultFloat("d1", std::numeric_limits<float>::lowest(), std::numeric_limits<float>::max(), 128.0f));
    testAssert(128.0 == cfg.getOrDefaultDouble("e1", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), 128.0));
