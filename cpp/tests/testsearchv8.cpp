...
{
  {
    ...
    auto [hist, board] = sgf->setupBoardAndHistAssumeLegal(initialRules, nextPla, 3,BoardHistoryModes(false,false));
...
{
  {
    ...
    Player nextPla;
    Rules initialRules = sgf->getRulesOrFail();
    auto [hist, board] = sgf->setupBoardAndHistAssumeLegal(initialRules, nextPla, 11,BoardHistoryModes(false,false));
...

  {
    ...
    Player nextPla;
    Rules initialRules = sgf->getRulesOrFail();
    auto [hist, board] = sgf->setupBoardAndHistAssumeLegal(initialRules, nextPla, 8,BoardHistoryModes(false,false));
...
.............x.....
...

  {
...

    {
      ...
      auto [hist, board] = sgf->setupBoardAndHistAssumeLegal(initialRules, nextPla, 24,BoardHistoryModes(false,false));
      SearchParams params = SearchParams::forTestsV1();
      params.maxVisits = 200;
    ...
    }
    {
      Player nextPla;
      Rules initialRules = sgf->getRulesOrFailAllowUnspecified(Rules::getTrompTaylorish());
      auto [hist, board] = sgf->setupBoardAndHistAssumeLegal(initialRules, nextPla, 32,BoardHistoryModes(false,false));
      SearchParams params = SearchParams::forTestsV1();
      params.maxVisits = 200;
      params.antiMirror = true;
      AsyncBot* bot = new AsyncBot(params, nnEval, &logger, "antimirrortest");
    ...
    }
    {
      Player nextPla;
      Rules initialRules = sgf->getRulesOrFailAllowUnspecified(Rules::getTrompTaylorish());
      auto [hist, board] = sgf->setupBoardAndHistAssumeLegal(initialRules, nextPla, 124,BoardHistoryModes(false,false));
      SearchParams params = SearchParams::forTestsV1();
      params.maxVisits = 200;
      params.antiMirror = true;
      AsyncBot* bot = new AsyncBot(params, nnEval, &logger, "antimirrortest");
...

  {
...

    {
      Player nextPla;
      Rules initialRules = sgf->getRulesOrFailAllowUnspecified(Rules::getTrompTaylorish());
      auto [hist, board] = sgf->setupBoardAndHistAssumeLegal(initialRules, nextPla, 29,BoardHistoryModes(false,false));
      SearchParams params = SearchParams::forTestsV1();
      params.maxVisits = 200;
      params.antiMirror = true;
      AsyncBot* bot = new AsyncBot(params, nnEval, &logger, "antimirrortest");
    ...
    }
    {
      Player nextPla;
      Rules initialRules = sgf->getRulesOrFailAllowUnspecified(Rules::getTrompTaylorish());
      auto [hist, board] = sgf->setupBoardAndHistAssumeLegal(initialRules, nextPla, 83,BoardHistoryModes(false,false));
      SearchParams params = SearchParams::forTestsV1();
      params.maxVisits = 200;
      params.antiMirror = true;
      AsyncBot* bot = new AsyncBot(params, nnEval, &logger, "antimirrortest");
