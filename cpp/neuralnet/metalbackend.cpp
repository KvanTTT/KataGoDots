...
void MetalProcess::getMetalOutput(
  ...
  testAssert((NNModelVersion::getNumSpatialFeatures(gpuHandle->version, dotsGame) * gpuHandle->nnXLen * gpuHandle->nnYLen) <= (int)inputBuffers->singleInputElts);
  testAssert(NNModelVersion::getNumGlobalFeatures(gpuHandle->version, dotsGame) == (int)inputBuffers->singleInputGlobalElts);
