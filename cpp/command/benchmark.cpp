...
int MainCmds::benchmark(const vector<string>& args) {
  ...
  if(string nnMaxBatchSize; cfg.tryGetString("nnMaxBatchSize", nnMaxBatchSize))
    cout << "NOTE: Your config hardcodes nnMaxBatchSize = " + nnMaxBatchSize + ". This benchmark ignores it, and the notes at the end say how to keep it consistent with what was measured." << endl;
